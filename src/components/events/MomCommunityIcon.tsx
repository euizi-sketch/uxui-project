    ...
    >
      <defs>
        ...
        <linearGradient id={`heart-${uid}`} x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="100%" stopColor="#FF853E" />
        </linearGradient>
        <radialGradient id={`halo-${uid}`} cx="50%" cy="42%" r="55%">
          <stop offset="0%" stopColor="#FFFFFF" stopOpacity="0.9" />
          <stop offset="70%" stopColor="#FFE8DC" stopOpacity="0.35" />
          <stop offset="100%" stopColor="#FF853E" stopOpacity="0" />
        </radialGradient>
        <filter id={`lift-${uid}`} x="-25%" y="-25%" width="150%" height="150%">
          <feDropShadow dx="0" dy="3" stdDeviation="2.8" floodColor="#FF853E" floodOpacity="0.2" />
      ...
      <ellipse cx="50" cy="86" rx="32" ry="8" fill="#FF853E" fillOpacity="0.12" />

      <g filter={`url(#lift-${uid})`}>
        <circle cx="32" cy="50" r="16" fill={`url(#face-${uid})`} stroke="#FFD2BF" strokeWidth="1.2" />
        <circle cx="50" cy="46" r="18" fill={`url(#face-${uid})`} stroke="#FFB08A" strokeWidth="1.3" />
        <circle cx="68" cy="50" r="16" fill={`url(#face-${uid})`} stroke="#FFD2BF" strokeWidth="1.2" />
