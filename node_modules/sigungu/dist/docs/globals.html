		...
		<div class="container">
			<div class="table-wrap">
				<div class="table-cell">
					<strong><a href="index.html">sigungu</a></strong>
				</div>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class=" tsd-kind-enum">
			<a href="enums/addressclass.html" class="tsd-kind-icon">Address<wbr>Class</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="interfaces/addressunit.html" class="tsd-kind-icon">Address<wbr>Unit</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="interfaces/emdong.html" class="tsd-kind-icon">Emdong</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="interfaces/sido.html" class="tsd-kind-icon">Sido</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="interfaces/sigungu.html" class="tsd-kind-icon">Sigungu</a>
		</li>
		<li class=" tsd-kind-variable tsd-is-not-exported">
			<a href="globals.html#axios" class="tsd-kind-icon">axios</a>
		</li>
		<li class=" tsd-kind-variable tsd-is-not-exported">
			<a href="globals.html#year" class="tsd-kind-icon">year</a>
		</li>
		<li class=" tsd-kind-function tsd-is-not-exported">
			<a href="globals.html#getadm" class="tsd-kind-icon">get<wbr>Adm</a>
		</li>
		<li class=" tsd-kind-function tsd-is-not-exported">
			<a href="globals.html#getsido" class="tsd-kind-icon">get<wbr>Sido</a>
		</li>
		<li class=" tsd-kind-function tsd-is-not-exported">
			<a href="globals.html#getsigungu" class="tsd-kind-icon">get<wbr>Sigungu</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#getsub" class="tsd-kind-icon">get<wbr>Sub</a>
		</li>
	</ul>
</nav>
	...
	<div class="content-wrap">
		<div class="tsd-panel tsd-typography">
			...
			<p><a href="https://github.com/prettier/prettier"><img src="https://img.shields.io/badge/styled_with-prettier-ff69b4.svg" alt="styled with prettier"></a>
				<a href="https://greenkeeper.io/"><img src="https://badges.greenkeeper.io/haedaal/sigungu.svg" alt="Greenkeeper badge"></a>
				<a href="https://travis-ci.org/haedaal/sigungu"><img src="https://img.shields.io/travis/haedaal/sigungu.svg" alt="Travis"></a>
				<a href="https://coveralls.io/github/haedaal/sigungu"><img src="https://img.shields.io/coveralls/haedaal/sigungu.svg" alt="Coveralls"></a>
			<a href="https://david-dm.org/haedaal/sigungu?type=dev"><img src="https://david-dm.org/haedaal/sigungu/dev-status.svg" alt="Dev Dependencies"></a></p>
			<p>A minimal address data of south korea</p>
			<h3 id="installation">Installation</h3>
			<pre><code class="lang-bash"><span class="hljs-comment"># Run npm install</span>
npm install --save sigungu
</code></pre>
			<h3 id="description">Description</h3>
			<p>3 단계로 구분한 간략한 주소 데이터</p>
			<ol>
				<li>(특별/광역)시도 (class A)</li>
				<li>시군구 (class B)</li>
				<li><p>읍면동 (class C)</p>
				</li>
				<li><p>광역시가 아닌 일반 시의 주소(예: 충청북도 청주시 상당구 가덕면) 는 시, 구(청주시 상당구) 를 class B 에 할당</p>
				</li>
			</ol>
			<pre><code class="lang-js"><span class="hljs-comment">// index.js</span>
<span class="hljs-keyword">const</span> { sidoList, getSub } = <span class="hljs-built_in">require</span>(<span class="hljs-string">'sigungu'</span>);
<span class="hljs-comment">// import {sidoList, getSub} from 'sigungu'</span>

<span class="hljs-comment">// 광역시 / 도</span>
<span class="hljs-keyword">const</span> sido = sidoList[<span class="hljs-number">0</span>];

<span class="hljs-built_in">console</span>.log(sido.code, sido.name);

<span class="hljs-comment">// 시군구 (예외 존재)</span>
<span class="hljs-keyword">const</span> sigungu = getSub(sido)[<span class="hljs-number">0</span>];

<span class="hljs-built_in">console</span>.log(sigungu.code, sigungu.name);

<span class="hljs-comment">// 동면</span>
<span class="hljs-keyword">const</span> dongmyeon = getSub(sigungu)[<span class="hljs-number">0</span>];

<span class="hljs-built_in">console</span>.log(dongmyeon.code, dongmyeon.name);

<span class="hljs-comment">// no more</span>
<span class="hljs-keyword">const</span> more = getSub(dongmyeon);

<span class="hljs-built_in">console</span>.log(more);
</code></pre>
...
[]
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-enum"><a href="enums/addressclass.html" class="tsd-kind-icon">Address<wbr>Class</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Interfaces</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-interface"><a href="interfaces/addressunit.html" class="tsd-kind-icon">Address<wbr>Unit</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/emdong.html" class="tsd-kind-icon">Emdong</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/sido.html" class="tsd-kind-icon">Sido</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/sigungu.html" class="tsd-kind-icon">Sigungu</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-not-exported">
						<h3>Variables</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-variable tsd-is-not-exported"><a href="globals.html#axios" class="tsd-kind-icon">axios</a></li>
							<li class="tsd-kind-variable tsd-is-not-exported"><a href="globals.html#year" class="tsd-kind-icon">year</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Functions</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-function tsd-is-not-exported"><a href="globals.html#getadm" class="tsd-kind-icon">get<wbr>Adm</a></li>
							<li class="tsd-kind-function tsd-is-not-exported"><a href="globals.html#getsido" class="tsd-kind-icon">get<wbr>Sido</a></li>
							<li class="tsd-kind-function tsd-is-not-exported"><a href="globals.html#getsigungu" class="tsd-kind-icon">get<wbr>Sigungu</a></li>
							<li class="tsd-kind-function"><a href="globals.html#getsub" class="tsd-kind-icon">get<wbr>Sub</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-not-exported">
			...
			<section class="tsd-panel tsd-member tsd-kind-variable tsd-is-not-exported">
				...
				<h3>axios</h3>
				<div class="tsd-signature tsd-kind-icon">axios<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">any</span><span class="tsd-signature-symbol"> =&nbsp;require(&#x27;axios&#x27;)</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/haedaal/sigungu/blob/c74fa5e/src/makeAddress.ts#L1">makeAddress.ts:1</a></li>
					</ul>
				</aside>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-variable tsd-is-not-exported">
				...
				<h3>year</h3>
				<div class="tsd-signature tsd-kind-icon">year<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">2016</span><span class="tsd-signature-symbol"> =&nbsp;2016</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/haedaal/sigungu/blob/c74fa5e/src/makeAddress.ts#L3">makeAddress.ts:3</a></li>
					</ul>
				</aside>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-function tsd-is-not-exported">
				<a name="getadm" class="tsd-anchor"></a>
				<h3>get<wbr>Adm</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-is-not-exported">
					<li class="tsd-signature tsd-kind-icon">get<wbr>Adm<span class="tsd-signature-symbol">(</span>sidoCode<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span>, sggCode<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/haedaal/sigungu/blob/c74fa5e/src/makeAddress.ts#L46">makeAddress.ts:46</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>sidoCode: <span class="tsd-signature-type">any</span></h5>
							</li>
							<li>
								<h5>sggCode: <span class="tsd-signature-type">any</span></h5>
							</li>
						</ul>
			...
			<section class="tsd-panel tsd-member tsd-kind-function tsd-is-not-exported">
				<a name="getsido" class="tsd-anchor"></a>
				<h3>get<wbr>Sido</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-is-not-exported">
					<li class="tsd-signature tsd-kind-icon">get<wbr>Sido<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/haedaal/sigungu/blob/c74fa5e/src/makeAddress.ts#L5">makeAddress.ts:5</a></li>
							</ul>
						</aside>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">any</span></h4>
					</li>
			...
			<section class="tsd-panel tsd-member tsd-kind-function tsd-is-not-exported">
				<a name="getsigungu" class="tsd-anchor"></a>
				<h3>get<wbr>Sigungu</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-is-not-exported">
					<li class="tsd-signature tsd-kind-icon">get<wbr>Sigungu<span class="tsd-signature-symbol">(</span>sidoCode<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/haedaal/sigungu/blob/c74fa5e/src/makeAddress.ts#L25">makeAddress.ts:25</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
			...
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="getsub" class="tsd-anchor"></a>
				<h3>get<wbr>Sub</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">get<wbr>Sub<span class="tsd-signature-symbol">(</span>addr<span class="tsd-signature-symbol">: </span><a href="interfaces/addressunit.html" class="tsd-signature-type">AddressUnit</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="interfaces/addressunit.html" class="tsd-signature-type">AddressUnit</a><span class="tsd-signature-symbol">[]</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/haedaal/sigungu/blob/c74fa5e/src/sigungu.ts#L7">sigungu.ts:7</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>addr: <a href="interfaces/addressunit.html" class="tsd-signature-type">AddressUnit</a></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="interfaces/addressunit.html" class="tsd-signature-type">AddressUnit</a><span class="tsd-signature-symbol">[]</span></h4>
					</li>
				</ul>
			</section>
		</section>
