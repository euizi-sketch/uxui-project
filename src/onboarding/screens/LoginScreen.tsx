  ...
  return (
    <div className="relative w-full py-2">
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-[#E0F3F9]" />
        <div className="absolute -top-24 left-1/2 h-72 w-72 -translate-x-1/2 rounded-full bg-[#A1D0DF]/40 blur-3xl" />
      ...
      <div className="w-full max-w-sm space-y-6">
        <div className="space-y-3 text-center">
          ...
          />
          <h2 className="text-2xl font-extrabold text-slate-900">로그인</h2>
