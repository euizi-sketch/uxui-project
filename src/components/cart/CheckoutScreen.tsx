...
export default function CheckoutScreen() {
  ...
  const payTotal = Math.max(0, subtotal - instantDiscount + shipping);
      ...
      <div className="app-viewport-fixed z-[95] flex flex-col bg-white">
        <header className="flex shrink-0 items-center border-b border-slate-100 bg-white px-2 pt-[max(0.5rem,env(safe-area-inset-top,0px))] pb-2">
          ...
          <button
            type="button"
            onClick={closeCart}
            className="inline-flex h-11 min-w-[2.75rem] shrink-0 items-center justify-center px-2 text-[13px] font-semibold text-slate-500"
          >
            닫기
          </button>
        </header>
        <div className="flex flex-1 flex-col items-center justify-center px-6 pb-24">
          <p className="text-center text-sm font-semibold text-slate-600">주문할 상품이 없어요.</p>
          <button
            type="button"
            onClick={backToCartFromCheckout}
    ...
    <div className="app-viewport-fixed z-[95] flex flex-col bg-white">
      ...
      {done ? (
        <div className="flex min-h-0 flex-1 flex-col items-center justify-center px-6 pb-32">
          ...
          <p className="mt-1 text-center text-2xl font-extrabold tabular-nums text-[#FF853E]">
          ...
          <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain pb-36">
            ...
            <section className="border-b border-slate-100 px-4 py-4">
              ...
              <div className="mt-3 space-y-3">
                <label className="block">
                  <span className="text-[11px] font-semibold text-slate-500">받는 분</span>
                  <input
                    value={receiverName}
                ...
                <label className="block">
                  <span className="text-[11px] font-semibold text-slate-500">주소</span>
                  <textarea
                    value={address}
            ...
            <section className="bg-slate-50 px-4 py-4">
              ...
              <div className="mt-3 space-y-2 text-[13px]">
                ...
                <div className="flex justify-between border-t border-slate-200 pt-3 text-[16px] font-extrabold text-slate-900">
                  <span>총 결제</span>
