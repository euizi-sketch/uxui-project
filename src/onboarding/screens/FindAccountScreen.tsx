    ...
    <div className="space-y-5">
      ...
      <div className="space-y-3 rounded-2xl border border-slate-200 bg-white p-5">
        ...
        <p className="text-xs leading-5 text-slate-600">
          ...
          <span className="font-semibold text-slate-800">가입 시 닉네임</span>과 동일하게 입력해
          주세요.
        </p>
        ...
        <button
          type="button"
          className="mt-2 h-12 w-full rounded-xl bg-[#FF853E] px-4 text-sm font-extrabold text-white transition hover:bg-[#FF6F1F]"
        ...
        {tab === "id" && result.foundId && (
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-700">
            ...
            <p className="mt-1">
              회원님의 아이디는{" "}
              <span className="font-extrabold text-[#FF853E]">{result.foundId}</span>
              입니다.
            </p>
          </div>
        )}
