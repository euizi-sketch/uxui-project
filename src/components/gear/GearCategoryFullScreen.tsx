  ...
  return (
    ...
    >
      <header className="flex shrink-0 items-center gap-3 border-b border-slate-100 bg-white px-3 py-3 pt-[max(0.75rem,env(safe-area-inset-top,0px))]">
        ...
        <h1 className="min-w-0 flex-1 text-lg font-extrabold text-slate-900">카테고리</h1>
      </header>
          ...
          {categories.map((c) => {
            ...
            return (
              <button
                ...
                className={`w-full px-2 py-3.5 text-center text-[11px] font-extrabold leading-snug sm:text-xs ${
        ...
        <div className="min-w-0 flex-1 overflow-y-auto bg-white">
          <div className="sticky top-0 z-[1] border-b border-slate-50 bg-white/95 px-4 pb-3 pt-3 backdrop-blur-sm">
            <div className="flex items-center gap-2">
              <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-[#FF853E] text-[10px] font-extrabold text-white">
                M
              </span>
            ...
            <div className="mt-3 flex gap-2">
              <button
                type="button"
                className="min-h-[2.25rem] flex-1 rounded-xl border border-[#FF853E] bg-[#FFF8F4] py-2 text-[11px] font-extrabold text-[#FF853E] sm:text-xs"
              >
                신상품 보기
              </button>
              <button
                type="button"
                className="min-h-[2.25rem] flex-1 rounded-xl border border-[#FF853E] bg-white py-2 text-[11px] font-extrabold text-[#FF853E] sm:text-xs"
              >
                전체 보기
              </button>
            </div>
