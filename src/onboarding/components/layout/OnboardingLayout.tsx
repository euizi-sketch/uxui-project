...
export default function OnboardingLayout({
  ...
  return (
    <div
      className={`flex min-h-[100dvh] w-full flex-col bg-[#E0F3F9] px-5 pb-safe-tab pt-[calc(2rem+env(safe-area-inset-top,0px))] ${containerClassName}`}
    >
      ...
      {ctaLabel && onCtaClick && (
        <footer className="app-bottom-fixed z-40 border-t border-slate-200 bg-[#E0F3F9] px-5 pb-[calc(1.25rem+env(safe-area-inset-bottom,0px))] pt-4">
