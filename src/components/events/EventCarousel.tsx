...
export function EventCarousel() {
  ...
  return (
    <section
      className="rounded-[28px] border border-slate-200/90 bg-white p-5 shadow-[0_12px_40px_-10px_rgba(15,23,42,0.12)] ring-1 ring-slate-200/60 sm:p-6"
      aria-labelledby="momoa-event-carousel-title"
      onMouseEnter={() => setAutoPaused(true)}
      onMouseLeave={() => setAutoPaused(false)}
    >
      <div className="mb-5">
        <div className="relative overflow-hidden rounded-[22px] border border-[#FFD2BF]/60 bg-[#FFF8F4] p-5 shadow-[0_12px_40px_-16px_rgba(255,133,62,0.25)] ring-1 ring-white/90 sm:p-6">
            <div
              className="pointer-events-none absolute -right-4 top-0 h-36 w-36 rounded-full bg-[#FF853E]/20 blur-3xl"
              aria-hidden="true"
            />
            <div
            ...
            <div className="relative z-[1] flex flex-wrap items-center gap-2 break-keep">
              <span className="inline-flex items-center gap-1 rounded-full bg-[#FF853E] px-3 py-1 text-[10px] font-extrabold uppercase tracking-wider text-white shadow-md shadow-orange-200/50">
              ...
              <span className="max-w-none rounded-2xl bg-white/90 px-3 py-1.5 text-[10px] font-extrabold leading-snug text-slate-600 ring-1 ring-slate-200/80 sm:text-[11px] sm:leading-tight">
                엄마들의 선택 데이터가 쌓이는 공간
              </span>
            </div>
            ...
            >
              <span
                className="block text-[clamp(1.55rem,5.2vmin,2.25rem)] leading-[1.08] tracking-tight text-[#FF853E] drop-shadow-[0_2px_12px_rgba(255,133,62,0.35)]"
                style={{ fontFamily: '"GeekbleMalang2", "MOMOA UI", system-ui, sans-serif' }}
              >
                모모아
              </span>
              ...
              <span
                className="mt-4 inline-flex h-2 w-[min(12rem,55%)] rounded-full bg-[#FF853E] shadow-sm shadow-orange-200/50"
                aria-hidden="true"
              />
            </h2>
            ...
            <div className="relative z-[1] mt-5 space-y-2 text-left text-base font-semibold leading-relaxed text-slate-700 sm:text-[1.05rem]">
              ...
              <p className="break-keep">
                <span className="font-extrabold text-[#FF853E] drop-shadow-[0_1px_0_rgba(255,133,62,0.2)]">
                  엄마들이 같이 짓는 작은 무대
                </span>
                에요!
              </p>
            ...
            <div className="relative z-[1] mt-5 rounded-2xl border border-slate-200/80 bg-white/95 py-5 pl-4 pr-[5.25rem] text-left shadow-sm ring-1 ring-white/90 backdrop-blur-[2px] sm:pl-5 sm:pr-28">
              <div
                className="absolute left-0 top-3 bottom-3 w-1 rounded-full bg-[#FF853E]"
                aria-hidden="true"
              />
              <div
                ...
                aria-hidden="true"
              >
                <div className="absolute inset-0 rounded-full border-2 border-dashed border-[#FF853E]/25" />
                <MomCommunityIcon className="relative h-[3.35rem] w-[3.35rem] drop-shadow-[0_4px_12px_rgba(255,133,62,0.2)] sm:h-[3.65rem] sm:w-[3.65rem]" />
              </div>
              <div className="min-w-0 pl-3 sm:pl-4">
                <p className="text-left leading-snug">
                  ...
                  <span className="mt-1.5 block break-keep text-[10px] font-semibold leading-relaxed text-slate-500 text-pretty sm:mt-2 sm:text-[11px] sm:leading-relaxed">
      ...
      <div className="relative">
        <button
          ...
          disabled={!canLeft}
          className="absolute left-0 top-1/2 z-20 hidden h-11 w-11 -translate-x-2 -translate-y-1/2 items-center justify-center rounded-2xl bg-white text-lg text-slate-700 shadow-md ring-1 ring-slate-200 transition hover:bg-slate-50 disabled:pointer-events-none disabled:opacity-0 sm:flex"
        >
          ‹
        </button>
        <button
          ...
          onClick={() => scrollByDir(1)}
          disabled={!canRight}
          className="absolute right-0 top-1/2 z-20 hidden h-11 w-11 translate-x-2 -translate-y-1/2 items-center justify-center rounded-2xl bg-white text-lg text-slate-700 shadow-md ring-1 ring-slate-200 transition hover:bg-slate-50 disabled:pointer-events-none disabled:opacity-0 sm:flex"
        >
          ›
        </button>
      ...
      <div className="mt-4 space-y-3">
        ...
        >
          <div
            className="h-full rounded-full bg-[#FF853E] transition-[width] duration-500 ease-out"
          ...
          {EVENT_CAROUSEL_ITEMS.map((ev, i) => (
            <button
              ...
              className={`h-2 rounded-full transition-all duration-300 ${
                i === activeIndex ? "w-6 bg-[#FF853E]" : "w-2 bg-slate-300 hover:bg-slate-400"
              }`}
            />
          ))}
        </div>
