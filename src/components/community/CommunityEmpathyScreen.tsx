      ...
      {!activeRoomId && (
        <>
            ...
            <div className="-mx-0 flex gap-3 overflow-x-auto overflow-y-visible px-5 pb-1 pt-0.5 [scrollbar-width:thin] snap-x snap-mandatory sm:px-6">
              {FEATURED_ROOMS.map((room) => (
                ...
                >
                  ...
                  <p className="mt-2 min-h-[2.5rem] text-center text-[12px] font-extrabold leading-snug text-slate-800 line-clamp-2 sm:text-xs">
                    {room.name}
                  </p>
                </button>
              ))}
          ...
          <section className="border-b border-slate-100 bg-white px-5 py-4 sm:px-6" aria-label="오늘의 스토리">
            <p className="mb-3 text-[11px] font-extrabold uppercase tracking-wide text-slate-400">오늘의 맘 스토리</p>
          ...
          <main className="mx-auto max-w-app px-0">
            <div className="flex items-center gap-2 border-b border-slate-100 bg-white px-5 py-3 sm:px-6">
              ...
              <span className="ml-auto text-[11px] font-semibold text-slate-400">실시간 데모</span>
            </div>
        ...
        <main className="mx-auto max-w-app px-0">
          <div className="sticky top-0 z-10 flex items-center gap-3 border-b border-slate-100 bg-white/95 px-5 py-3 backdrop-blur-md sm:px-6">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-[15px] font-extrabold leading-snug text-slate-900 line-clamp-2">{activeRoom.name}</p>
            ...
            {roomPosts.length === 0 ? (
              <div className="py-14 text-center">
                ...
                <button
                  ...
                  className="mt-4 rounded-full bg-[#FF853E] px-6 py-3 text-sm font-extrabold text-white shadow-md"
                >
                  첫 글 남기기
                </button>
              </div>
